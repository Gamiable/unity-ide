...
namespace Packages.IDE.Editor
{
	...
	{
		private static readonly string[] EditorNames = { "code", "cursor", "windsurf", "antigravity", "zed", "subl", "nv" };

		private static readonly string[] EditorDisplayNames = {
			"Visual Studio Code", "Cursor", "Windsurf", "Antigravity", "Zed", "Sublime Text", "Neovim"
		};
		...
		private static bool IsSupportedInstallation(string path)
		{
			...
			var names = new[] { "code", "cursor", "windsurf", "antigravity", "zed", "subl", "sublime_text", "neovim", "nv" };
