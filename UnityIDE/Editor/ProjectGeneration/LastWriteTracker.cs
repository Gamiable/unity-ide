...
namespace Packages.IDE.Editor.ProjectGeneration
{
	internal static class LastWriteTracker
	{
		internal static bool HasLastWriteTimeChanged()
		{
			...
			return files.Any(a => a.LastWriteTime > IDEScriptEditorPersistedState.instance.LastWrite);
		}
		...
		internal static void UpdateLastWriteIfNeeded(string path)
		{
			...
			{
				IDEScriptEditorPersistedState.instance.LastWrite = fileInfo.LastWriteTime;
			}
		}
