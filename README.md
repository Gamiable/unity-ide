...
Unity package providing multi-editor IDE integration — **VS Code, Cursor, Windsurf, Antigravity, Zed, Neovim**.

Forked from `com.unity.ide.rider` (v3.0.40) and adapted for VSCode-family and other editors.

## Features

- **Editor discovery** — auto-detects VS Code, Cursor, Windsurf, Antigravity, Zed, and Neovim installations on macOS and Linux (Windows: VSCode-family only)
